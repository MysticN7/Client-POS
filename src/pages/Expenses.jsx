    ...
    return (
        <div>
            <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold">Expense Vouchers</h2>
                <button
            ...
            {showForm && (
                <div className="bg-white p-6 rounded shadow mb-6">
                    <h3 className="text-lg font-bold mb-4">New Expense Voucher</h3>
                    <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4">
                        ...
                        <input placeholder="Category (e.g. Rent, Salary)" className="border p-2 rounded" value={formData.category} onChange={e => setFormData({ ...formData, category: e.target.value })} required />
                        <input type="number" placeholder="Amount" className="border p-2 rounded" value={formData.amount} onChange={e => setFormData({ ...formData, amount: e.target.value })} required />
