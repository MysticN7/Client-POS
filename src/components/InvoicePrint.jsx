                                    ...
                                    <tbody>
                                        {(rx.right?.distance?.sph || rx.right?.distance?.cyl || rx.right?.distance?.axis || rx.left?.distance?.sph || rx.left?.distance?.cyl || rx.left?.distance?.axis) && (
                                            <tr>
                                                ...
                                                <td className="py-2" style={{ border: '1px dashed #000', fontWeight: 700 }}>{getVal('right', 'distance', 'sph')}</td>
                                                <td className="py-2" style={{ border: '1px dashed #000', fontWeight: 700 }}>{getVal('right', 'distance', 'cyl')}</td>
                                                <td className="py-2" style={{ border: '1px dashed #000', fontWeight: 700 }}>{getVal('right', 'distance', 'axis')}</td>
                                                <td className="py-2" style={{ border: '1px dashed #000', fontWeight: 700 }}>{getVal('left', 'distance', 'sph')}</td>
                                                <td className="py-2" style={{ border: '1px dashed #000', fontWeight: 700 }}>{getVal('left', 'distance', 'cyl')}</td>
                                                <td className="py-2" style={{ border: '1px dashed #000', fontWeight: 700 }}>{getVal('left', 'distance', 'axis')}</td>
                                            </tr>
                                        )}
                                        {(rx.right?.near?.sph || rx.right?.near?.cyl || rx.right?.near?.axis || rx.left?.near?.sph || rx.left?.near?.cyl || rx.left?.near?.axis) && (
                                            <tr>
                                                ...
                                                <td className="py-2" style={{ border: '1px dashed #000', fontWeight: 700 }}>{getVal('right', 'near', 'sph')}</td>
                                                <td className="py-2" style={{ border: '1px dashed #000', fontWeight: 700 }}>{getVal('right', 'near', 'cyl')}</td>
                                                <td className="py-2" style={{ border: '1px dashed #000', fontWeight: 700 }}>{getVal('right', 'near', 'axis')}</td>
                                                <td className="py-2" style={{ border: '1px dashed #000', fontWeight: 700 }}>{getVal('left', 'near', 'sph')}</td>
                                                <td className="py-2" style={{ border: '1px dashed #000', fontWeight: 700 }}>{getVal('left', 'near', 'cyl')}</td>
                                                <td className="py-2" style={{ border: '1px dashed #000', fontWeight: 700 }}>{getVal('left', 'near', 'axis')}</td>
                                            </tr>
                                        )}
