            ...
            <div className="bg-white dark:bg-gray-900 dark:text-gray-100 rounded-lg shadow-lg w-full max-w-3xl max-h-[90vh] overflow-y-auto print:hidden">
                ...
                <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                        <div>
                            <h3 className="text-xs sm:text-sm font-semibold text-gray-500 dark:text-gray-300 mb-2">Invoice Number</h3>
                        ...
                        <div>
                            <h3 className="text-xs sm:text-sm font-semibold text-gray-500 dark:text-gray-300 mb-2">Payment Method</h3>
                            <p className="text-sm sm:text-lg">{invoice.payment_method}</p>
                        </div>
                    </div>

                    {/* Customer Info */}
                    <div className="bg-blue-50 dark:bg-gray-800 p-3 sm:p-4 rounded-lg">
                        <h3 className="text-xs sm:text-sm font-semibold text-gray-700 dark:text-gray-200 mb-2">Customer Information</h3>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            <div>
                                <span className="text-xs sm:text-sm text-gray-600 dark:text-gray-300">Name:</span>
                                <p className="font-medium text-sm sm:text-base">{invoice.Customer?.name || 'N/A'}</p>
                            </div>
                            <div>
                                <span className="text-xs sm:text-sm text-gray-600 dark:text-gray-300">Phone:</span>
                                <p className="font-medium text-sm sm:text-base">{invoice.Customer?.phone || 'N/A'}</p>
                            </div>
                            {invoice.Customer?.address && (
                                <div className="col-span-1 sm:col-span-2">
                                    <span className="text-xs sm:text-sm text-gray-600 dark:text-gray-300">Address:</span>
                    ...
                    <div>
                        ...
                        <div className="overflow-x-auto -mx-2 sm:mx-0">
                            <table className="w-full border dark:border-gray-700 min-w-[500px]">
                                        ...
                                        <tr key={index} className="border-b dark:border-gray-700">
                                            <td className="px-2 sm:px-4 py-3">
                                                ...
                                                {item.prescription_data && (
                                                    <div className="mt-2 text-xs sm:text-sm bg-gray-50 dark:bg-gray-700 p-2 sm:p-3 rounded border dark:border-gray-700">
                                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 mb-2">
                                                            <div>
                                                                <p className="font-bold text-gray-600 dark:text-gray-300 mb-1 text-xs sm:text-sm">Right Eye:</p>
                                                                <div className="space-y-1">
                                                                    <p className="text-gray-500 dark:text-gray-300 text-xs sm:text-sm break-words">
                                                            ...
                                                            <div>
                                                                <p className="font-bold text-gray-600 dark:text-gray-300 mb-1 text-xs sm:text-sm">Left Eye:</p>
                                                                <div className="space-y-1">
                                                                    <p className="text-gray-500 dark:text-gray-300 text-xs sm:text-sm break-words">
                                                                        <span className="font-medium">D:</span>{' '}
                                                                        <span className="text-gray-700 dark:text-gray-100">
                    ...
                    {invoice.PaymentHistories && invoice.PaymentHistories.length > 0 && (
                        <div>
                            <h3 className="text-xs sm:text-sm font-semibold text-gray-700 dark:text-gray-200 mb-3">Payment History</h3>
                            <div className="space-y-2">
                                    ...
                                    <div key={index} className="bg-green-50 dark:bg-gray-800 p-3 rounded border-l-4 border-green-500">
                                        <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-2 sm:gap-0">
                                            <div>
                                                ...
                                                {payment.notes && (
                                                    <p className="text-xs text-gray-500 dark:text-gray-400 italic mt-1">{payment.notes}</p>
                                                )}
                                            </div>
                    ...
                    {invoice.note && (
                        <div>
                            <h3 className="text-xs sm:text-sm font-semibold text-gray-700 dark:text-gray-200 mb-2">Notes</h3>
                            <p className="text-gray-600 dark:text-gray-100 bg-yellow-50 dark:bg-yellow-900 p-3 rounded text-sm">{invoice.note}</p>
                        </div>
                    )}
